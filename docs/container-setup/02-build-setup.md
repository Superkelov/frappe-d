...
Combine the base compose file with appropriate overrides for your use case. This example adds MariaDB and exposes ports on `:8080` (Redis is already bundled):
